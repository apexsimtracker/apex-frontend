...
const PUBLIC_HOME_DESCRIPTION = `${COMPANY_NAME}: session logging, telemetry, leaderboards, challenges, community, and coaching insights — one place for every sim you run. Open sim racing hub at ${SITE_ORIGIN.replace(/^https:\/\//, "")}.`;
          ...
          <section className="mx-auto mt-14 max-w-6xl sm:mt-16 lg:mt-20">
            ...
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              ...
              <SectionCard>
                ...
                <p className="mt-2 text-sm leading-relaxed text-muted-foreground">
                  Go deeper with telemetry uploads, Apex Agent, analytics, and Pro-only perks — join
                  the waitlist after you sign up.
                </p>
              </SectionCard>
            </div>
          </section>
