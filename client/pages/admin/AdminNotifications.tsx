              ...
              <tbody>
                {rows.map((b) => (
                  <tr key={b.id} className="border-b border-white/5">
                    ...
                    <td className="p-3 text-muted-foreground">{b.audienceSummary}</td>
                    ...
                    <td className="p-3">{b.viewCount}</td>
                    <td className="p-3">{b.dismissalCount}</td>
                    <td className="p-3">
                      <DropdownMenu>
            ...
            <table className="w-full text-left text-sm">
              <thead>
                <tr className="border-b border-white/10 text-muted-foreground">
                  ...
                  <th className="p-3">Audience</th>
                  <th className="p-3">Sent (in-app)</th>
                  <th className="p-3">Sent (email)</th>
              ...
              <tbody>
                {rows.map((c) => (
                  <tr key={c.id} className="border-b border-white/5">
                    ...
                    <td className="p-3 text-muted-foreground">{c.audienceSummary}</td>
                    <td className="p-3">{c.inAppSentCount}</td>
                    <td className="p-3">{c.emailSentCount}</td>
                    <td className="p-3">
                    ...
                    <td className="p-3 text-muted-foreground">{c.emailSkippedCount}</td>
                    <td className="p-3 text-xs text-muted-foreground">
