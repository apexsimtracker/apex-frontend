      ...
      <div className="mx-auto max-w-6xl">
        ...
        {!isPending && data && (
          <>
            ...
            <div className="mb-8 grid gap-4 rounded-xl border border-white/10 p-4 sm:grid-cols-2">
              <div>
                ...
                <table className="w-full text-left text-sm">
                  <thead>
                    <tr className="border-b border-white/10 text-muted-foreground">
                      <th className="px-4 py-3 text-xs font-semibold uppercase tracking-wider">Lap</th>
                      ...
                      <th className="px-4 py-3 text-xs font-semibold uppercase tracking-wider">Valid</th>
                      <th className="px-4 py-3 text-xs font-semibold uppercase tracking-wider">Best</th>
                      ...
                      adminLapsView.rows.map(({ lap, s1, s2, s3 }) => {
                        ...
                        return (
                          ...
                          >
                            ...
                            <td className="px-4 py-3">{lap.isValid ? "yes" : "no"}</td>
                            <td className="px-4 py-3">{lap.isBestLap ? "★" : "—"}</td>
