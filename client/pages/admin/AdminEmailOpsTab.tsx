                ...
                <table className="w-full text-left text-sm">
                  <thead>
                    <tr className="border-b border-white/10 text-muted-foreground">
                      ...
                      <th className="p-3">Code expires</th>
                      <th className="p-3">Email status</th>
                      <th className="p-3 text-right tabular-nums">Risk</th>
                  ...
                  <tbody>
                    {verRows.map((r) => (
                      <tr key={r.id} className="border-b border-white/5">
                        ...
                        <td className="p-3 text-muted-foreground">{r.emailStatus}</td>
                        <td className="p-3 text-right tabular-nums text-muted-foreground">{r.emailRiskScore}</td>
                ...
                <table className="w-full text-left text-sm">
                  <thead>
                    <tr className="border-b border-white/10 text-muted-foreground">
                      ...
                      <th className="p-3 text-right tabular-nums">Attempts</th>
                  ...
                  <tbody>
                    {prRows.map((r) => (
                      <tr key={r.id} className="border-b border-white/5">
                        <td className="p-3 font-mono text-xs text-muted-foreground">{r.emailMasked}</td>
                        <td className="p-3 text-muted-foreground tabular-nums">{formatTs(r.expiresAt)}</td>
                        <td className="p-3 text-right tabular-nums text-muted-foreground">{r.attempts}</td>
