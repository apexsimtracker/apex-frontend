                  ...
                  <tbody>
                    {rows.map((r) => (
                      <tr key={r.id} className="border-b border-white/5">
                        ...
                        <td className="max-w-[12rem] truncate p-3 text-muted-foreground">{r.email}</td>
                        <td className="max-w-[14rem] truncate p-3 text-muted-foreground">
                          {subjectSnippet(r.subject)}
                        </td>
                        <td className="p-3 text-muted-foreground">{formatContactStatus(r.status)}</td>
                        <td className="p-3">
