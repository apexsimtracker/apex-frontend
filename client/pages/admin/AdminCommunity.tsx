              ...
              <table className="w-full min-w-[720px] text-left text-sm">
                <thead>
                  <tr className="border-b border-white/10 text-muted-foreground">
                    ...
                    <th className="p-3 tabular-nums">Replies</th>
                  ...
                  {isPending ? (
                    ...
                    rows.map((r) => (
                      <tr key={r.id} className="border-b border-white/5">
                        <td className="max-w-[240px] p-3 font-medium text-foreground">
                          <Link
                        ...
                        <td className="p-3 text-muted-foreground">{statusLabel(r)}</td>
                        <td className="p-3 tabular-nums text-muted-foreground">{r.commentCount}</td>
                        <td className="p-3 text-muted-foreground">
              ...
              <table className="w-full min-w-[640px] text-left text-sm">
                <thead>
                  <tr className="border-b border-white/10 text-muted-foreground">
                    ...
                    <th className="p-3">Discussion</th>
                  ...
                  {flagsQuery.isPending ? (
                    ...
                    flagRows.map((f: AdminModerationFlagRow) => (
                      <tr key={f.id} className="border-b border-white/5">
                        <td className="p-3 font-medium text-foreground">{f.kind}</td>
                        <td className="p-3">
                          <Link
                        ...
                        <td className="p-3 text-muted-foreground">{f.createdAt}</td>
