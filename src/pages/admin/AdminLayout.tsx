    ...
    <>
      ...
      <div className="fixed inset-x-0 top-16 z-30 flex h-14 items-center gap-3 border-b border-white/10 bg-background/95 px-4 backdrop-blur-md lg:hidden">
        <button
          ...
          className="inline-flex size-10 shrink-0 items-center justify-center rounded-lg border border-white/10 bg-secondary/40 text-foreground transition-colors hover:bg-secondary/70 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary/70"
      ...
      <aside
        id="admin-sidebar"
        className={cn(
          "fixed left-0 z-50 flex w-[min(18rem,88vw)] flex-col border-r border-white/10 bg-[hsl(var(--background))] shadow-[8px_0_24px_rgba(0,0,0,0.35)] transition-[transform,width] duration-200 ease-out",
      ...
      <div
        className={cn(
          "min-h-0 min-w-0 flex-1 overflow-y-auto overscroll-contain px-4 py-8 sm:px-6 lg:pr-10",
          "max-lg:pt-14",
