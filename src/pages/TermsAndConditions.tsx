            ...
            <div className="space-y-8 text-sm leading-relaxed text-foreground/90 [&_a]:text-white/70 [&_a]:underline [&_a]:underline-offset-2 [&_a]:hover:text-white [&_strong]:text-foreground">
              <section className="space-y-3">
                ...
                <p>
                  ...
                  and use of the website, web application, Capacitor mobile app,
                  and Apex Agent desktop software operated by {COMPANY_NAME}
                  (“we”, “us”, “our”) at{" "}
                  <a href={SITE_ORIGIN}>
                ...
                <p>
                  Use of the Apex Agent desktop application is also subject to
                  our <Link to="/eula">End User License Agreement (EULA)</Link>.
                  Our <Link to="/privacy-policy">Privacy Policy</Link> describes
              ...
              <section className="space-y-3">
                ...
                <p>
                  ...
                  optional desktop background application that monitors
                  supported simulators locally and uploads session summaries to
                  your account when configured and authorised.
                </p>
                <p>
              ...
              <section className="space-y-3">
                ...
                <p>
                  ...
                  under your account, including activity performed through the
                  Apex Agent when signed in with your credentials. You must be
                  at least 13 years old to use the Service, or the minimum age
                  required in your country if higher.
                </p>
                <p>
                  ...
                  control and that you sign out or uninstall the Agent when you
                  no longer wish it to upload data on your behalf.
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <p>
                  ...
                  or where necessary to protect the Service.
                </p>
                ...
                <ul className="list-disc space-y-1.5 pl-5 text-foreground/90">
                  ...
                  <li>
                    ...
                    <code className="text-foreground/80">.ibt</code> files or Le
                    Mans Ultimate{" "}
                  ...
                  <li>
                    ...
                    servers over HTTPS when you are authenticated and entitled
                    to use upload features;
                  </li>
                  <li>
                ...
                <p>
                  You must not use the Agent or any modified version to
                  intercept telemetry you are not authorised to collect,
                  interfere with other users’ systems, or exfiltrate data beyond
                  the scope of the Service. You are responsible for compliance
                  with your simulator’s licence terms and any applicable
              ...
              <section className="space-y-3">
                ...
                <p>
                  You retain rights in content you submit, including session
                  data, telemetry, posts, and comments. You grant us a
                  worldwide, non-exclusive licence to host, store, reproduce,
                  process, analyse, and display your content solely to operate
                  and improve the Service (including telemetry charts, personal
                  bests, leaderboards, and community features). You represent
                  that you have the rights needed to grant this licence and that
              ...
              <section className="space-y-3">
                ...
                <p>
                  The Service, including software, branding, and design, is
                  owned by {COMPANY_NAME} or its licensors. Simulator names,
                  tracks, and car data displayed in the Service may be
                  trademarks of their respective owners. Except as expressly
                  allowed, you may not copy, modify, distribute, reverse
                  engineer, or create derivative works from our materials.
                  Additional restrictions on the Apex Agent are set out in the{" "}
              ...
              <section className="space-y-3">
                ...
                <p>
                  ...
                  Pro-tier features may include automated Agent uploads,
                  extended session history access, advanced telemetry charts,
                  and other capabilities we designate as Pro-only.
                </p>
                ...
                <p>
                  <strong>
                    Pro-tier and system feature locks are governed exclusively
                    by your current, valid subscription entitlement as evaluated
                    by our billing infrastructure.
                  </strong>{" "}
                  We determine entitlement by synchronising subscription state
                  from RevenueCat (our subscription management provider), which
                  in turn reflects payment status processed by Stripe. An
                  active, non-delinquent Pro subscription is required for
                  Pro-gated features including, without limitation, Apex Agent
                  session uploads and certain telemetry analysis endpoints.
                </p>
                <p>
                  If your subscription lapses, is cancelled, enters a grace
                  period, or becomes delinquent, Pro features may be disabled
                  immediately or after any applicable grace period communicated
                  at checkout. We are not liable for loss of access to Pro
                  features resulting from expired or unpaid subscriptions. You
                  may restore access by renewing or updating your payment method
                  through the billing portal provided in Settings or on the
                  Pricing page.
                </p>
                ...
                <p>
                  Paid subscriptions are processed through RevenueCat and
                  Stripe. By subscribing, you agree to RevenueCat’s and Stripe’s
                ...
                <p>
                  Refund eligibility is determined by applicable consumer law
                  and the policies of our payment processors. Contact{" "}
              ...
              <section className="space-y-3">
                ...
                <p>
                  ...
                  privacy notices. We are not responsible for third-party
                  content, simulator availability, or third-party practices
                  beyond our reasonable selection and contractual requirements
                  of sub-processors.
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <p>
                  ...
                  error-free operation, accurate lap timing relative to official
                  race control, or compatibility with every simulator version or
              ...
              <section className="space-y-3">
                ...
                <p>
                  ...
                  fraud. Subject to that, to the fullest extent permitted by
                  law, we are not liable for any indirect, incidental, special,
                  consequential, or punitive damages, or for loss of profits,
                  data, or goodwill. Our total liability for any claim arising
                  out of or relating to the Service is limited to the greater of
                  £100 or the amounts you paid us for the Service in the twelve
              ...
              <section className="space-y-3">
                ...
                <p>
                  You will defend and indemnify {COMPANY_NAME} and its
                  directors, officers, and employees against claims, damages,
                  losses, and expenses (including reasonable legal fees) arising
                  from your use of the Service, your content, your operation of
                  the Apex Agent, or your breach of these Terms, to the extent
                  permitted by law.
                </p>
              </section>
              ...
              <section className="space-y-3">
                ...
                <p>
                  ...
                  account in Settings. We may suspend or terminate your access
                  for breach of these Terms, non-payment, or to protect the
                  Service. On termination, your right to use the Service ceases;
              ...
              <section className="space-y-3">
                ...
                <p>
                  ...
                  permitted by law. Material changes may be communicated by
              ...
              <section className="space-y-3">
                ...
                <p>
                  ...
                  resolve disputes arising from or relating to these Terms or
                  the Service, subject to any mandatory rights you may have as a
