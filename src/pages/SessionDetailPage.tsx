...
import { TelemetryAnalysisSection } from "@/features/telemetry-analysis/TelemetryAnalysisSection";
    ...
    <div className="mx-auto w-full max-w-7xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <>
        ...
        {visibleLaps.length > 0 && (
          <div className="mb-2 flex flex-wrap items-center gap-x-4 gap-y-1 px-1 text-[11px] text-white/45">
            ...
            <tbody>
              {visibleLaps.length === 0 ? (
                ...
                visibleLaps.map((row, index) => {
                  const rowHighlights =
                    lapHighlights.get(row.lap) ?? defaultLapHighlights;
                  const isFastest =
