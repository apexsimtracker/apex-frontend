...
export default function TelemetryLapPicker({
  laps,
  selectedLap,
  compareLap,
  onSelectLap,
    ...
    <div className="flex flex-col gap-3 sm:flex-row sm:items-end sm:justify-between">
      <div className="flex min-w-0 flex-1 items-center gap-2">
        <button
          ...
          className="flex size-10 shrink-0 items-center justify-center rounded-[0.5rem] border border-apex-outline-variant/40 bg-apex-surface-container text-apex-on-surface transition-colors hover:bg-apex-surface-container-high disabled:cursor-not-allowed disabled:opacity-40"
        ...
        <DropdownMenu open={primaryOpen} onOpenChange={setPrimaryOpen}>
          <DropdownMenuTrigger asChild>
            ...
            >
              ...
              <ChevronDown
                className={cn(
                  "ml-2 size-4 shrink-0 text-apex-on-surface-variant transition-transform duration-200",
          ...
          <DropdownMenuContent
            align="start"
            className={cn(appDropdownContentClassName, "max-h-72 w-[min(100vw-2rem,20rem)] overflow-y-auto")}
          >
            <DropdownMenuRadioGroup
      ...
      <div className="w-full sm:w-56">
        <p className="mb-1 font-apex-body text-[10px] font-bold uppercase tracking-widest text-apex-on-surface-variant">
          Compare lap
        </p>
        <DropdownMenu open={compareOpen} onOpenChange={setCompareOpen}>
          ...
          <DropdownMenuContent
            align="end"
            className={cn(appDropdownContentClassName, "max-h-72 w-56 overflow-y-auto")}
          >
            <DropdownMenuRadioGroup
