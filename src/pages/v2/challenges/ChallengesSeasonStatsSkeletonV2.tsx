  ...
  return (
    <div
      className={cn(
        ...
        alignClass,
        bordered &&
          "border-y border-v2-outline-variant/15 py-6 sm:border-x sm:border-y-0 sm:py-0",
      )}
    >
      <SkeletonBlock
      ...
      />
      <SkeletonBlock
        className={cn("h-9 w-16 rounded-v2-sm", blockClassName)}
      />
      <SkeletonBlock
        className={cn("h-3 w-28 rounded-v2-sm", blockClassName)}
      />
    </div>
  );
}

export default function ChallengesSeasonStatsSkeletonV2() {
  return (
    <section
      className="border-y border-v2-outline-variant/15 py-5"
      aria-busy="true"
