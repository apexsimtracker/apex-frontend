...
import LoginWelcomePanelV2 from "./login/LoginWelcomePanelV2";
import LoginFormCardV2 from "./login/LoginFormCardV2";
import LoginHelpStripV2 from "./login/LoginHelpStripV2";

const LOGIN_V2_PATH = "/v2/login";
      ...
      <div className="mx-auto flex min-h-0 w-full max-w-5xl flex-1 flex-col px-6 py-8">
        <div className="relative flex flex-1 flex-col justify-center overflow-hidden py-4 lg:py-8">
          ...
          <div className="relative space-y-8">
            ...
            <LoginHelpStripV2 locationState={location.state} />
          </div>
        </div>
      </div>
    </>
