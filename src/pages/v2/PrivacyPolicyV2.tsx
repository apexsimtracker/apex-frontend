...
const PRIVACY_V2_PATH = "/v2/privacy-policy";
          ...
          <div className="space-y-8">
            ...
            <section className="space-y-3">
              ...
              <ul className={listClassName}>
                <li>
                  <strong className="text-v2-on-surface">Registration:</strong>{" "}
                  email address, password (stored as a salted hash; we never
                  store plain-text passwords), and optional display name.
                </li>
                <li>
                  <strong className="text-v2-on-surface">Profile:</strong> name,
              ...
              <p className={bodyClassName}>
                <strong className="text-v2-on-surface">Important:</strong> the
            ...
            <section className="space-y-3">
              ...
              <ul className={listClassName}>
                <li>
                  <strong className="text-v2-on-surface">F1 25 (UDP):</strong>{" "}
            ...
            <section className="space-y-3">
              ...
              <ul className={listClassName}>
                ...
                <li>
                  <strong className="text-v2-on-surface">Rectification:</strong>{" "}
