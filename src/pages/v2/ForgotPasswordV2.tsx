...
import ForgotPasswordWelcomePanelV2 from "./forgot-password/ForgotPasswordWelcomePanelV2";
import ForgotPasswordFormCardV2, {
  type ForgotPasswordStep,
} from "./forgot-password/ForgotPasswordFormCardV2";
import ForgotPasswordHelpStripV2 from "./forgot-password/ForgotPasswordHelpStripV2";

const FORGOT_PASSWORD_V2_PATH = "/v2/forgot-password";
        ...
        <div className="relative flex flex-1 flex-col justify-center overflow-hidden py-4 lg:py-8">
          ...
          <div className="relative space-y-8">
            <div className="grid gap-8 lg:grid-cols-2 lg:items-center lg:gap-12">
              <ForgotPasswordWelcomePanelV2 />
              <ForgotPasswordFormCardV2
                step={step}
                emailForm={emailForm}
                codeForm={codeForm}
                resetForm={resetForm}
