...
import ChallengeDetailHeroV2, {
  challengeStatusLabel,
} from "@/pages/v2/challenges/ChallengeDetailHeroV2";
import ChallengeDetailOverviewV2 from "@/pages/v2/challenges/ChallengeDetailOverviewV2";
  ...
  if (challenge.banned) {
    ...
    return (
      <>
        ...
        />
        <PageShell>
          <div className="rounded-v2-lg border border-v2-error/30 bg-v2-error/10 p-6 font-v2-body text-sm text-v2-error">
    ...
    <>
      ...
      <PageShell>
        ...
        {followPreview.length > 0 && (
          <div className="rounded-2xl border border-v2-outline-variant/15 bg-v2-surface-container px-4 py-3 font-v2-body text-sm text-v2-on-surface-variant">
        ...
        {tab === "overview" && (
          <ChallengeDetailOverviewV2
            challenge={challenge}
            challengeId={id}
            status={status}
            activeTimeRemainingSec={activeTimeRemainingSec}
            upcomingScheduleText={upcomingScheduleText}
          />
        )}

        {tab === "leaderboard" && (
          <ChallengeDetailLeaderboardV2
