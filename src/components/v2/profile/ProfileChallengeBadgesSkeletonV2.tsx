...
export function ProfileChallengeBadgesSkeletonV2() {
  return (
    <div
      className="mt-4"
      aria-busy="true"
    ...
    >
      <div className="mb-1.5 flex flex-wrap items-center justify-between gap-2">
        <SkeletonBlock className={`h-3 w-24 rounded-v2-sm ${sk}`} />
        <SkeletonBlock className={`h-3.5 w-[4.5rem] rounded-v2-sm ${sk}`} />
      </div>
