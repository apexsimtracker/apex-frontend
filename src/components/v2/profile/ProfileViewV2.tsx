...
import { ProfileHeaderV2 } from "@/components/v2/profile/ProfileHeaderV2";
import { ProfileKeyStatsV2 } from "@/components/v2/profile/ProfileKeyStatsV2";
import { ProfileWeeklyActivityV2 } from "@/components/v2/profile/ProfileWeeklyActivityV2";
import { ProfileMainDisciplinesV2 } from "@/components/v2/profile/ProfileMainDisciplinesV2";
import { ProfileRaceHistoryV2 } from "@/components/v2/profile/ProfileRaceHistoryV2";
import { ProfileStatsByGameV2 } from "@/components/v2/profile/ProfileStatsByGameV2";
import { cn } from "@/lib/utils";

type ProfileViewV2Props = {
    ...
    <div className={cn("min-h-0 bg-transparent", rootClassName)}>
      <div className={cn("w-full space-y-6", containerClassName)}>
        {onBack && (
          <button
            onClick={onBack}
            className="mb-2 flex items-center gap-2 font-v2-body text-v2-on-surface-variant transition-colors hover:text-v2-on-surface"
          >
        ...
        {!profileLocked &&
          ...
          profile.insight.body && (
            ...
            >
              ...
              <div className="mt-1 font-v2-body text-sm text-v2-on-surface">
                {profile.insight.body}
              </div>
            </Link>
          )}
